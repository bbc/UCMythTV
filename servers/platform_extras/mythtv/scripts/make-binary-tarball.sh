...
mkdir var/lib/mythtv/banners
mkdir var/lib/mythtv/coverart
mkdir var/lib/mythtv/db_backups
mkdir var/lib/mythtv/fanart
mkdir var/lib/mythtv/livetv
mkdir var/lib/mythtv/recordings
mkdir var/lib/mythtv/videos

chmod -R 2775 var/lib/mythtv
cd ..
...
echo ""
echo "--------------------------"
echo "COMPRESSING BINARY TARBALL"
echo "--------------------------"
echo ""
echo ""
cd install-root
tar -cvzf ../UCMythTV-MythTV-0.24-bin.tar.gz . || exit 1
cd ..
